...
namespace Chronic
{
    ...
    public class FrenchPointerScanner : ITokenScanner
    {
        static readonly dynamic[] Patterns = new dynamic[]
            {
                new { Pattern = new Regex(@"\bdans\b"), Tag = new Pointer(Pointer.Type.Future) },
                new { Pattern = new Regex(@"\bfuture\b"), Tag = new Pointer(Pointer.Type.Future) },
                new { Pattern = new Regex(@"\bavant\b"), Tag = new Pointer(Pointer.Type.Past) },
            };
