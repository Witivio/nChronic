...
//            Parse(" dans 7 jours à minuit", "fr").AssertEquals(Time.New(2006, 8, 24));
        ...
        {
            Parse("2 weeks ago").AssertEquals(Time.New(2006, 8, 02, 14));
            Parse("il y a 2 semaines", "fr").AssertEquals(Time.New(2006, 8, 02, 14));
        ...
        {
            Parse("two weeks ago").AssertEquals(Time.New(2006, 8, 02, 14));
            Parse("il y a 2 semaines", "fr").AssertEquals(Time.New(2006, 8, 02, 14));
        }
