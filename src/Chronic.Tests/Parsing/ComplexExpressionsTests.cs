...
namespace Chronic.Tests.Parsing
{
    public class ComplexExpressionsTests : ParsingTestsBase
    {
        ...
        public void days_are_parsed_correctly()
        {
            ...
            Parse("il y a 7 jours", "fr").AssertStartsAt(Time.New(2011, 10, 11, TimeOfDay));
        }
        ...
        public void weeks_are_parsed_correctly()
        {
            ...
            Parse("il y a 3 semaines", "fr").AssertStartsAt(Time.New(2011, 09, 27, TimeOfDay));
        }
        ...
        public void months_are_parsed_correctly()
        {
            ...
            Parse("il y a 7 mois", "fr").AssertStartsAt(Time.New(2011, 03, 18, TimeOfDay));
        }
        ...
        public void years_are_parsed_correctly()
        {
            ...
            Parse("il y a 7 ans", "fr").AssertStartsAt(Time.New(2004, 10, 18, TimeOfDay));
